      ...
      <section className="relative pt-24 pb-16 bg-gradient-to-br from-primary-50 to-secondary-50">
        <div className="container-custom">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="text-center">
            <motion.p variants={fadeInUp} className="text-primary-500 font-medium mb-4">About Us</motion.p>
            ...
            <motion.p variants={fadeInUp} className="text-secondary-600 text-lg max-w-2xl mx-auto">
              Mengenal lebih dekat tentang Cat Cafe by Arlindo dan mengapa kami sangat mencintai pekerjaan ini
            </motion.p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
              ...
              <div className="space-y-4 text-secondary-600 leading-relaxed">
                <p>Cat Cafe by Arlindo bermula dari mimpi kecil seorang pecinta kucing yang ingin menciptakan tempat di mana orang dapat menikmati kopi berkualitas sambil bersantai dengan kucing-kucing lucu.</p>
                <p>Didirikan pada tahun 2023, kami memulai dengan hanya 3 kucing dan sekarang telah berkembang menjadi rumah bagi lebih dari 20 kucing dari berbagai ras.</p>
                <p>Setiap sudut cafe dirancang dengan cinta untuk确保 kenyamanan baik bagi manusia maupun kucing. Kami percaya bahwa setiap orang berhak mengalami kegembiraan sederhana dari berinteraksi dengan hewan yang menggemaskan.</p>
              </div>
            </motion.div>
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="relative">
              ...
              <motion.div animate={{ rotate: [0, 5, -5, 0] }} transition={{ duration: 4, repeat: Infinity }} className="absolute -bottom-6 -left-6 bg-white p-6 rounded-2xl shadow-card">
                <p className="text-4xl font-bold text-primary-500">2023</p>
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="bg-white rounded-3xl p-8 shadow-soft">
              ...
              <p className="text-secondary-600 leading-relaxed">Menjadi cafe kucing terdepan di Indonesia yang memberikan pengalaman unik dan tak terlupakan bagi setiap pengunjung, sambil meningkatkan kesejahteraan hewan peliharaan.</p>
            </motion.div>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="bg-white rounded-3xl p-8 shadow-soft">
              ...
              <ul className="text-secondary-600 space-y-3">
                <li>- Menyediakan kopi dan makanan berkualitas tinggi</li>
                <li>- Merawat kucing dengan penuh kasih sayang</li>
                <li>- Menciptakan lingkungan yang nyaman dan bersih</li>
                <li>- Memberikan pelayanan terbaik kepada pelanggan</li>
                <li>- Edukasi tentang perawatan kucing</li>
              </ul>
            </motion.div>
          </div>
        </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
            ...
            <p className="text-secondary-600 text-lg">Kucing-kucing menggemaskan yang siap memanjatimu</p>
          </motion.div>
      ...
      <section className="section-padding bg-primary-50">
        <div className="container-custom">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { title: 'Kasih Sayang', desc: 'Treat every cat like family' },
              { title: 'Kualitas', desc: 'Only the best for you' },
              { title: 'Keramahtamahan', desc: 'Warm and welcoming service' },
              { title: 'Kehijauan', desc: 'Eco-friendly practices' },
            ].map((value, index) => (
