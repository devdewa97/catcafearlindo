        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="flex flex-wrap justify-center gap-4">
              ...
              <a href="https://instagram.com/username_adopsi" target="_blank" rel="noopener noreferrer" className="bg-gradient-to-r from-purple-600 via-pink-500 to-orange-500 text-white px-6 md:px-8 py-2.5 md:py-3 rounded-2xl font-semibold hover:opacity-90 transition-all text-sm md:text-base flex items-center gap-2">
