...
const eventPackages = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1530103862676-de3c9ae5b7b4?w=600',
    price: 'Rp 3.500.000',
      ...
      <section className="relative pt-24 pb-12 bg-gradient-to-br from-primary-50 to-secondary-50">
        <div className="container-custom">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="text-center">
            ...
            <motion.p variants={fadeInUp} className="text-secondary-600 max-w-2xl mx-auto">Pilih paket event yang sesuai dengan kebutuhan Anda</motion.p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16 bg-gradient-to-br from-primary-500 via-primary-600 to-accent-500 relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center">
            ...
            <p className="text-white/90 mb-6 max-w-md mx-auto">Hubungi kami untuk konsultasi free dan mendapatkan promo menarik</p>
            <a href="https://wa.me/6281234567890" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-white text-primary-600 px-8 py-4 rounded-2xl font-semibold hover:shadow-lg hover:scale-105 transition-all">
